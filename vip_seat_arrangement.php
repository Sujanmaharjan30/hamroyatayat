...
$sql = "SELECT seats FROM bookings WHERE d_shift = '$shift' AND d_date = '$date' AND status <> 'cancel'";
...
<label for="bus6" class="label" <?php echo getLabelStyle('D6', $bookedSeats); ?> id="label6">D6</label>
        ...
        <input type="checkbox" id="bus26" name="bus[]" value="D26" onclick="toggleTick('bus26')" <?php echo isSeatBooked('D26', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus26" class="label" <?php echo getLabelStyle('D26', $bookedSeats); ?>  id="label26">D26</label>
        
        <input type="checkbox" id="" name="" value="">
            <label for=""  class="no-border" id=""></label>

        <input type="checkbox" id="bus27" name="bus[]" value="D2" onclick="toggleTick('bus27')" <?php echo isSeatBooked('D27', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus27" class="label" <?php echo getLabelStyle('D27', $bookedSeats); ?>  id="label27">D27</label>
        
        <input type="checkbox" id="bus28" name="bus[]" value="D28" onclick="toggleTick('bus28')" <?php echo isSeatBooked('D28', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus28" class="label"  <?php echo getLabelStyle('D28', $bookedSeats); ?> id="label28">D28</label>
        
        <input type="checkbox" id="bus29" name="bus[]" value="D29" onclick="toggleTick('bus29')" <?php echo isSeatBooked('D29', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus29" class="label"  <?php echo getLabelStyle('D29', $bookedSeats); ?> id="label29">D29</label>
       
        <input type="checkbox" id="bus30" name="bus[]" value="D30" onclick="toggleTick('bus30')" <?php echo isSeatBooked('D30', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus30" class="label"  <?php echo getLabelStyle('D30', $bookedSeats); ?> id="label30">D30</label>
       
        <input type="checkbox" id="bus31" name="bus[]" value="D31" onclick="toggleTick('bus31')" <?php echo isSeatBooked('D31', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus31" class="label"  <?php echo getLabelStyle('D31', $bookedSeats); ?> id="label31">D31</label>
       
        <input type="checkbox" id="bus32" name="bus[]" value="D32" onclick="toggleTick('bus32')" <?php echo isSeatBooked('D32', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus32" class="label"  <?php echo getLabelStyle('D32', $bookedSeats); ?> id="label32">D32</label>
       
        <input type="checkbox" id="bus33" name="bus[]" value="D33" onclick="toggleTick('bus33')" <?php echo isSeatBooked('D33', $bookedSeats) ? 'disabled' : ''; ?>>
        <label for="bus33" class="label"  <?php echo getLabelStyle('D33', $bookedSeats); ?> id="label33">D33</label>
